...
public class SettingsSharedPreferences$$Impl
  ...
  public int lastFragmentIndex() {
    return preferences.getInt("lastFragmentIndex", -1);
  }

  @Override
  @SuppressLint({"NewApi", "CommitPrefEdits"})
  public void lastFragmentIndex(int lastFragmentIndex) {
    preferences.edit().putInt("lastFragmentIndex", lastFragmentIndex).apply();
  }
  ...
  public void clearDefined() {
    ...
    editor.remove("lastFragmentIndex");
    editor.apply();
  }
  ...
  public void initDefaults() {
    ...
    this.lastFragmentIndex(this.lastFragmentIndex());
  }
